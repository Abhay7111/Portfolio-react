...
function Home() {
  return (
    <div className='w-full h-fit relative  text-white'>
          <span className='w-[1px] h-full bg-[#6BEBAE]/10 absolute top-0 left-40 md:left-10'></span>
          <span className='w-[1px] h-full bg-[#6BEBAE]/10 absolute top-0 left-20 md:left-[20%]'></span>
          <span className='w-[1px] h-full bg-[#6BEBAE]/10 absolute top-0 right-28 md:right-40'></span>
          <span className='w-[1px] h-full bg-[#6BEBAE]/10 absolute top-0 right-40 md:right-[42%]'></span>
               ...
               <div className='z-0 w-full opacity-60 h-full bg-transparent absolute top-0 left-0'><Maxdiv/></div>
                    <div className='h-20 flex-col relative items-start justify-start p-1'>
                         <div className='flex items-center justify-start gap-2 md:pl-32'>
                              ...
                              <span className='w-full md:w-80 h-[1px] bg-[#6BEBAE]/20 relative opacity-90'>
                    ...
                    <span className='w-full h-[1px] bg-[#6BEBAE]/20 absolute top-40 right-0 hidden md:block'></span>
          ...
          <div className='w-full h-96 py-10 px-3  '>
               <div className='relative w-full h-fit'>
                    <div className='w-full h-fit p-2 mb-8 flex items-center justify-start'>
                         <span className='border-t border-[#6BEBAE] text-[#6BEBAE] uppercase text-sm font-medium mx-2'>Projects</span>
          ...
          <div className='w-full h-60 flex items-start flex-col gap-3'>
                    <span className='px-2 ml-3 flex items-center justify-start gap-3'>
                         <span className='text-sm font-medium uppercase border-t border-[#6BEBAE]/80 text-[#6BEBAE]'>Started</span>
                         <span className='w-13 h-[1px] bg-[#6BEBAE]/30'></span>
                         <h3 className='text-2xl font-semibold uppercase'>from 2023 to Now</h3>
                    </span>
               <div className='w-96 h-40 ml-4 relative overflow-hidden'>
